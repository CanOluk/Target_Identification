...
settingsPreCalc_CIFAR100test % settings are different!

tic

% custom matricises for T.VESCS T.PROPERTIES!
load('CIFAR100_TEST.mat')
T.VECS=T_test.VECS;
T.PROPERTIES=T_test.PROPERTIES;
clear T_test
...
settSim.precalculationNAME='CIFAR100test_UNC'; % different file name
[T, settng] = loadPrecomputedData(settSim.precalculationNAME);

% Computational Simuatilation Settings
% SubExample 1: Detection 
% SubExample 2: Discrimination of main category
sub_example = 1;
models = [1];
settingsSimExp_CIFAR100test
...
settSim.filename ='CIFAR100test_UNC_EXAMPLE1';
...
% ONLY FOR DISCRIMINATION OF MAIN CATEGORIES: SUBEXAMPLE 2
